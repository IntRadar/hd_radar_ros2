...
* ### hd_radar_driver
    ...
    * ### hd_radar_heat.hpp
        Этот файл описывает класс, который используется для сборки сообщений в режиме карты дальность-скорость, передаваемых по протоколу UDP, и подготовки их к дальнейшей публикации в ROS2 формате.
    * ### hd_radar_pcl.hpp
